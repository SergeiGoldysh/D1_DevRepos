			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "1581b9a0-78b0-8fc4-45a6-4aac53779e0f",
							"code": "PDS_UsrPrice",
							"caption": "#ResourceString(PDS_UsrPrice)#",
							"dataValueType": 32
						},
						{
							"id": "59a3e1aa-a35a-bbef-fe39-854341aaae93",
							"code": "PDS_UsrType",
						...
						{
							"id": "9412480a-116a-8512-6fa4-1885f831034d",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "37360fe7-5e0f-d01c-b91b-2d86b344471a",
							"code": "PDS_CreatedOn",
							"caption": "#ResourceString(PDS_CreatedOn)#",
							"dataValueType": 7
						},
						{
							"id": "741c0c0b-2b8f-d9fd-021f-480dccfef8a7",
							"code": "PDS_UsrNumber",
